...
#+BEGIN_SRC emacs-lisp
  (let ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     `(mode-line-inactive ((,class (:background ,background-blue :height 0.9 :foreground ,default
                                                :distant-foreground ,background-blue
                                                :box ,(when zerodark-use-paddings-in-mode-line
                                                        (list :line-width 4 :color background-blue))))))
     ...
     ;; org stuff
     `(outline-1 ((,class (:foreground ,blue :weight bold :height 1.4 :bold nil))))
...
*** golden ratio
**** DONE workaround for helm 
CLOSED: [2018-05-15 Mar 19:21]
#+BEGIN_SRC emacs-lisp 
...
** TODO ido and why I started using helm
...
#+BEGIN_SRC emacs-lisp
  (defun ghetto/kill-inner-word ()
    "Kills the entire word your cursor is in. Equivalent to 'ciw' in vim."
    (interactive)
    (forward-char 1)
    (backward-word)
    (kill-word 1))
  (global-set-key (kbd "C-c w k") 'ghetto/kill-inner-word)
#+END_SRC

** Improved copy-word
And again, the same as above but we make sure to not delete the source word.
#+BEGIN_SRC emacs-lisp
  (defun ghetto/copy-whole-word ()
    (interactive)
    (save-excursion
      (forward-char 1)
      (backward-word)
      (kill-word 1)
      (yank)))
  (global-set-key (kbd "C-c w c") 'ghetto/copy-whole-word)
#+END_SRC

** Copy a line
Regardless of where your cursor is, this quickly copies a line.
#+BEGIN_SRC emacs-lisp
  (defun ghetto/copy-whole-line ()
    ...
    (save-excursion
      (kill-new
       (buffer-substring
        (point-at-bol)
        (point-at-eol)))))
  (global-set-key (kbd "C-c l c") 'ghetto/copy-whole-line)
#+END_SRC
...
GHETTONOTE: stop working when using guile REPL. Disable for now.
...
** Hungry deletion TO BE REVISITED
...
** Zapping to char TO BE REVISITED
